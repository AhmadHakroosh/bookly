...
- Admin → Bookings lists a booking's guests on single bookings too, not only on group-session seats
- Calendar invitations name the host's own address as the organizer instead of a placeholder
